...
def clean_data():
    ...
    corpus_target = []
    print "Reading data..."
    corpus_file = open ("/Users/ankit/code/nlp-metaphors/data/subtask5b_en_allwords_dev.txt", "r")
    data_file   = open ("/Users/ankit/code/nlp-metaphors/data/bow/allwords_dev.txt", "w")
    label_file  = open ("/Users/ankit/code/nlp-metaphors/data/bow/allwords_dev_label.txt", "w")
